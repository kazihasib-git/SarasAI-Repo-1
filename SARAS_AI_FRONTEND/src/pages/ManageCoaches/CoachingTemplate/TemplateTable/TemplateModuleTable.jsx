    ...
    <>
      {modulesData.map((module) => (
        <Box key={module.id}>
          ...
          >
            <p
              style={{ fontSize: "24px", justifyContent: "center", margin: 0 }}
            >
              {module.module_name}
              <span
                style={{
            ...
            >
              <CustomButton
                ...
                onClick={() =>
                  handleActivity(module.id, module?.template[0]?.id)
                }
              >
                <i className="bi bi-plus-circle"></i>
                <span style={{ marginLeft: "5px" }}>Add Activity</span>
              </CustomButton>
              ...
              >
                ...
                <span style={{ marginLeft: "5px" }}>Edit Module</span>
              </CustomButton>
            </div>
          </Box>
                  ...
                  <thead className="tableHead">
                    <tr>
                      {headers.map((header, index) => (
                        <th key={index} style={{ padding: "8px 0" }}>
                          {header}
                        </th>
                      ))}
                    </tr>
                  ...
                  <tbody className="tableBody">
                    {module.activities.map((activity, index) => (
                      <tr key={activity.id}>
                        ...
                        >
                          <CustomButton
                            onClick={openPrerequisitesPopup}
                            backgroundColor="#FEEBE3"
                          >
                            Prerequisite
                          </CustomButton>
