...
const CustomButton = ({ onClick, children, color = '#F56D3B', backgroundColor = '#4E18A5', borderColor = '#FFFFFF', sx, ...props }) => {
    return (
        <Button
            variant="contained"
            onClick={onClick}
    ...
    <div>
          ...
          <Box m="40px">
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center" mb="20px">
                <Typography variant="h6" component="p" sx={{ color:"#1A1E3D",fontSize: "40px", fontFamily: "ExtraLight" }}>
                    Call Records
                </Typography>
            ...
            <Box display="flex" flexWrap="wrap" gap="20px" justifyContent="space-between">
                {calls.map((call) => (
                    <Card key={call.id} sx={{ flex: '1 1 calc(33.333% - 20px)', backgroundColor: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minWidth: '250px' }}>
                        <CardContent>
                            ...
                            <Typography variant="body2" color="textSecondary">Time: {call.time}</Typography>
