    ...
    <aside id="sidebar" className="sidebar">
      <ul className="sidebar-nav" id="sidebar-nav">
        ...
        <li className="nav-item">
          ...
          <ul
            id="manage-tas-nav"
            className={`nav-content collapse ${activeLink.startsWith("/manage-") ? "show" : ""}`}
            data-bs-parent="#sidebar-nav"
          >
            <li>
              <Link
                to={"/ta-manage"}
                className={activeLink === "/ta-manage" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/ta-mapping"}
                className={activeLink === "/ta-mapping" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/ta-availability"}
                className={activeLink === "/ta-availability" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/ta-scheduling"}
                className={activeLink === "/ta-scheduling" ? "active" : ""}
        ...
        <li className="nav-item">
          ...
          >
            <li>
              <Link
                to={"/manage-coaches"}
                className={activeLink === "/manage-coaches" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/coach-mapping"}
                className={activeLink === "/coach-mapping" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/coach-template"}
                className={activeLink === "/coach-template" ? "active" : ""}
            ...
            <li>
              <Link
                ...
                className={activeLink === "/coach-availability" ? "active" : ""}
            ...
            <li>
              <Link
                to={"/coach-scheduling"}
                className={activeLink === "/coach-scheduling" ? "active" : ""}
        ...
        <li className="nav-item">
          <Link
            className={`nav-link ${activeLink === "/courses" ? "active" : "collapsed"}`}
            to={"/courses"}
