        ...
        const data = [
            ...
            return (
                ...
                <Typography variant="subtitle1" gutterBottom>
                        Bs in AI: Spring 24-28 | OS 101: US Batch 3, CL 201: IN Batch 6
                </Typography>
                
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 4 }}>
                <Card>
                <CardContent>
                <Typography variant="h6">Activities Scheduled</Typography>
                ...
                <Card>
                <CardContent>
                <Typography variant="h6">Due Dates Missed</Typography>
                <Typography variant="h4">3</Typography>
                </CardContent>
                </Card>
                </Box>
                ...
                >
                                    {activity.status === 'Locked' ? 'Unlock' : 'Reactivate'}
                </Button>
                </TableCell>
                </TableRow>
                            ))}
