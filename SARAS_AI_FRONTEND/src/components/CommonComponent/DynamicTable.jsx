          ...
          <Grid container spacing={2}>
              ...
              <Grid item xs={6} >
                ...
                >
                  <div>
                  <h5>Student Name</h5>
                  <h6 style={{textAlign:'center'}}>Ankit Sharma</h6>
                  </div>
                ...
                >
                  <div>
                  <h5>Academic Term</h5>
                  <h6 style={{textAlign:'center'}}>Lorem Ipsum</h6>
                  </div>
                ...
                >
                  <div>
                  <h5>Batch</h5>
                  <h6 style={{textAlign:'center'}}>Batch 1</h6>
                  </div>
                ...
                >
                  ...
                  <h6 style={{textAlign:'center'}}>Friday June 21, 11:00 to 11:30 AM</h6>
                  </div>
              ...
              <Grid item xs={6} >
                ...
                >
                  <div>
                  <h5>Student Name</h5>
                  <h6 style={{textAlign:'center'}}>Student Name</h6>
                  </div>
