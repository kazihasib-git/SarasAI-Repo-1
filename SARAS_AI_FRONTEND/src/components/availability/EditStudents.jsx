...
import { closeEditStudent, openScheduleSession } from "../../redux/features/taModule/taScheduling";
...
const EditStudents = ({ componentname }) => {
    ...
    const { openEditStudent, taID: taaId, students } = useSelector(state => state.taScheduling);
    ...
    const handleSubmit = () => {
        ...
        dispatch(openScheduleSession({ id, name: assignedName, student: selectedStudents.map((id) => ({ id }))}));
