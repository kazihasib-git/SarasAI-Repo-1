...
export const getWOLCategory = createAsyncThunk("wol/getWOLCategory", async () => {
  const response = await axios.get(`${baseUrl}/admin/wol/wol-category`);
  return response.data;
});

// To Create WOL Category
export const createWOLCategory = createAsyncThunk("wol/createWOLCategory", async (data) => {
  console.log(data)
  const response = await axios.post(`${baseUrl}/admin/wol/wol-category`, data);
  return response.data;
});

// To Update WOL Category
export const updateeWOLCategory = createAsyncThunk("wol/updateWOLCategory", async ({ id, data }) => {
  const response = await axios.put(`${baseUrl}/admin/wol/wol-category/${id}`, data);
  return response.data;
});

// To Delete WOL Category
export const deleteWOLCategory = createAsyncThunk("wol/deleteWOLCategory", async (id) => {
  const response = await axios.delete(`${baseUrl}/admin/wol/wol-category/${id}`);
  return response.data;
});

// To active deactive WOL Category
export const activeDeactiveWOLCategory = createAsyncThunk("wol/activeDeactiveWOLCategory", async (id) => {
  console.log('in activeDeactiveWOLCategory', id)
  const response = await axios.get(`${baseUrl}/admin/wol/wol-category/${id}`);
  return response.data;
});

// Get all life instruction data
export const getLifeInstruction = createAsyncThunk("wol/getLifeInstruction", async () => {
  const response = await axios.get(`${baseUrl}/admin/wol/wol-life-instruction`);
  return response.data;
});

// edit instructions data
export const editLifeInstruction = createAsyncThunk("wol/editLifeInstruction", async (data) => {
  const response = await axios.put(`${baseUrl}/admin/wol/wol-life-instruction`, data);
  return response.data;
});

// Get WOL Questions
export const getWOLQuestions = createAsyncThunk("wol/getWOLQuestions", async () => {
  const response = await axios.get(`${baseUrl}/admin/wol/wol-question`);
  return response.data;
});

// Create WOL Question
export const createWOLQuestion = createAsyncThunk("wol/createWOLQuestion", async (data) => {
  const response = await axios.post(`${baseUrl}/admin/wol/wol-question`, data);
  return response.data;
});

// Update WOL Question
export const updateWOLQuestion = createAsyncThunk("wol/updateWOLQuestion", async ({ id, data }) => {
  const response = await axios.put(`${baseUrl}/admin/wol/wol-question/${id}`, data);
  return response.data;
})

// Get WOL Options Config
export const getWOLOptionConfig = createAsyncThunk("wol/getWOLOptionConfig", async () => {
  const response = await axios.get(`${baseUrl}/admin/wol/wol-option-config`);
  return response.data;
})

// Add WOL Options Config
export const addWOLOptionConfig = createAsyncThunk("wol/addWOLOptionConfig", async (data) => {
  const response = await axios.post(`${baseUrl}/admin/wol/wol-option-config`, data);
  return response.data;
});


// Add WOL Test Config
export const addWOLTestConfig = createAsyncThunk("wol/addWOLTestConfig", async (data) => {
  const response = await axios.post(`${baseUrl}/admin/wol/wol-test-config`, data);
  return response.data;
});

// Get All Wol Test Config
export const getWolTestConfig = createAsyncThunk("wol/getWolTestConfig", async () => {
  const response = await axios.get(`${baseUrl}/admin/wol/wol-test-config`);
  return response.data;
});
